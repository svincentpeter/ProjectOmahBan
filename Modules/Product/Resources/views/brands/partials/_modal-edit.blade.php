        ...
        <div class="relative bg-white rounded-2xl shadow-2xl dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-5 border-b border-zinc-100 rounded-t dark:border-gray-600">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-black dark:text-white">Edit Merek</h3>
                        <p class="text-xs text-zinc-500">Ubah nama merek produk</p>
                    </div>
                </div>
            ...
            <form id="form-edit" method="POST">
                ...
                <div class="p-5">
                    <div class="mb-4">
                        <label for="edit-name" class="block mb-2 text-sm font-bold text-black dark:text-white">
                        ...
                        <input type="text" 
                               ...
                               required>
                        <p id="edit-error" class="mt-2 text-sm text-red-600 hidden"></p>
                    </div>
                </div>
                <!-- Modal footer -->
                <div class="flex items-center justify-end gap-2 p-5 border-t border-zinc-100 rounded-b dark:border-gray-600">
                    <button type="button" data-modal-hide="modal-edit" class="px-5 py-2.5 text-sm font-semibold text-zinc-700 bg-white border border-zinc-300 rounded-xl hover:bg-zinc-50 focus:ring-4 focus:outline-none focus:ring-zinc-200 transition-all">
