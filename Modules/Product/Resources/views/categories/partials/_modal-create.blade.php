        ...
        <div class="relative bg-white rounded-2xl shadow-2xl dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-5 border-b border-zinc-100 rounded-t dark:border-gray-600">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-black dark:text-white">Tambah Kategori Baru</h3>
                        <p class="text-xs text-zinc-500">Masukkan kode dan nama kategori</p>
                    </div>
                </div>
                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="modal-create-category">
                    <i class="bi bi-x-lg"></i>
                    <span class="sr-only">Close modal</span>
                </button>
            </div>
            <!-- Modal body -->
            <form id="form-create-category" action="{{ route('product-categories.store') }}" method="POST">
                @csrf
                <div class="p-5 space-y-4">
                    <div>
                        <label for="create-category-code" class="block mb-2 text-sm font-bold text-black dark:text-white">
                        ...
                        <p id="create-category-code-error" class="mt-2 text-sm text-red-600 hidden"></p>
                    </div>
                    <div>
                        <label for="create-category-name" class="block mb-2 text-sm font-bold text-black dark:text-white">
                ...
                <div class="flex items-center justify-end gap-2 p-5 border-t border-zinc-100 rounded-b dark:border-gray-600">
                    <button type="button" data-modal-hide="modal-create-category" class="px-5 py-2.5 text-sm font-semibold text-zinc-700 bg-white border border-zinc-300 rounded-xl hover:bg-zinc-50 focus:ring-4 focus:outline-none focus:ring-zinc-200 transition-all">
