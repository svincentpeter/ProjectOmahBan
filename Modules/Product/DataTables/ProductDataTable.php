...
class ProductDataTable extends DataTable
{
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('image', function ($data) {
                ...
                return '<img src="/images/fallback_product_image.png" width="50" height="50" class="img-thumbnail">';
            })
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->buttons(Button::make('excel')->text('<i class="bi bi-file-earmark-excel-fill"></i> Excel'), Button::make('print')->text('<i class="bi bi-printer-fill"></i> Cetak'), Button::make('reset')->text('<i class="bi bi-x-circle"></i> Reset'), Button::make('reload')->text('<i class="bi bi-arrow-repeat"></i> Muat Ulang'));
    }
    ...
    protected function getColumns()
    {
        ...
        return [
            Column::make('product_name')->title('Nama Barang')->className('align-middle'),
            ...
            Column::computed('product_price')->title('Harga Jual')->className('text-center align-middle'),

            Column::make('stok_awal')->title('Stok Awal')->className('text-center align-middle'),

            Column::computed('stok_sisa')->title('Stok Sisa')->className('text-center align-middle'),

            Column::make('product_stock_alert')->title('Stok Min.')->className('text-center align-middle'),

            Column::computed('action')->title('Aksi')->exportable(false)->printable(false)->width(60)->className('text-center align-middle'),
        ];
    }
