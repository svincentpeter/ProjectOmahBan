...
<div class="container-fluid">
    <form action="{{ route('currencies.update', $currency) }}" method="POST" autocomplete="off">
        @csrf
        @method('PUT')
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control text-uppercase" id="code" name="code"
                                           maxlength="3" value="{{ old('code', $currency->code) }}" required>
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control text-center" id="thousand_separator"
                                           name="thousand_separator" maxlength="1"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control text-center" id="decimal_separator"
                                           name="decimal_separator" maxlength="1"
