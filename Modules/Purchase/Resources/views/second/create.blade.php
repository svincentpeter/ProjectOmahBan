...
@section('title', 'Input Pembelian Produk Bekas')
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-10 mb-3">
                                    ...
                                    <small class="text-muted">Pilih produk ban/velg bekas yang akan dibeli dari
                                        customer</small>
                                </div>
                ...
                <div class="col-lg-4 mb-4">
                    ...
                    <div class="card shadow-sm mb-4">
                        ...
                        <div class="card-body">
                            ...
                            {{-- Reference (auto) --}}
                            <div class="form-group">
                                <label class="form-label font-weight-semibold">Reference</label>
                                <input type="text" class="form-control bg-light" value="Auto Generate" readonly>
                                <small class="text-muted">Reference akan di-generate otomatis</small>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="customer_name" id="customer_name"
                                    ...
                                    value="{{ old('customer_name') }}" placeholder="Nama customer yang jual produk bekas"
                                    required>
                                @error('customer_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <select name="payment_method" id="payment_method"
                                    ...
                                    <option value="Tunai"
                                        {{ old('payment_method', 'Tunai') == 'Tunai' ? 'selected' : '' }}>
                                        Tunai
                                    </option>
                            ...
                            <div class="form-group" id="bank-name-group" style="display: none;">
                                ...
                                <input type="text" name="bank_name" id="bank_name"
                                    ...
                                    value="{{ old('bank_name') }}" placeholder="Contoh: BCA, Mandiri, BRI">
                                @error('bank_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="paid_amount" id="paid_amount"
                                    class="form-control @error('paid_amount') is-invalid @enderror" value="0"
                                    min="0" step="1">
                                @error('paid_amount')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#purchase-form').submit(function(e) {
                ...
                $.ajax({
                    url: '{{ route('purchases.second.store') }}',
                    type: 'POST',
                    data: {
                        _token: '{{ csrf_token() }}',
