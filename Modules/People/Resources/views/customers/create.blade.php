                        ...
                        <div class="p-6 border-b border-zinc-100">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-zinc-500">Lengkapi data customer untuk transaksi penjualan</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-zinc-200 sticky top-24">
                        <div class="p-5 border-b border-zinc-100">
                            <div class="flex items-center gap-3">
                                ...
                                <h5 class="text-lg font-bold text-zinc-800">Informasi</h5>
                            </div>
                        </div>
                        ...
                        <div class="p-5">
                            ...
                            <div class="bg-blue-50 rounded-xl p-4 mb-4 border border-blue-100">
                                <div class="flex items-start gap-3">
                                    <i class="bi bi-lightbulb-fill text-blue-600 mt-1"></i>
                                    <div>
                                        <h6 class="text-sm font-bold text-blue-800 mb-1">Tips Pengisian:</h6>
                                        <ul class="text-xs text-blue-700 list-disc list-inside space-y-1">
                                            <li>Pastikan email aktif</li>
                                            <li>No. telepon bisa format lokal/int'l</li>
                                            <li>Alamat minimal 10 karakter</li>
                                            <li>Data bisa diupdate nanti</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="space-y-3">
                                <button type="submit" class="w-full flex items-center justify-center px-4 py-3 bg-indigo-600 text-white text-sm font-medium rounded-xl hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-200 group">
                                    <i class="bi bi-save me-2 group-hover:scale-110 transition-transform"></i> Simpan Customer
                                </button>
                            ...
                            <div class="mt-4 p-4 bg-zinc-50 rounded-xl border border-zinc-100">
                                <h6 class="text-xs font-bold text-zinc-600 mb-1 flex items-center">
                                    <i class="bi bi-shield-check me-1.5 text-zinc-500"></i> Keamanan Data
                                </h6>
                                <p class="text-xs text-zinc-500 leading-relaxed">
                                    Data customer disimpan aman dan hanya dapat diakses oleh user berwenang.
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#customer-form').on('submit', function(e) {
                ...
                submitBtn.html('<span class="inline-block animate-spin rounded-full h-4 w-4 border-b-2 border-white me-2"></span>Menyimpan...');
                
                // If form submission fails (e.g. server validation), revert button (optional, handled by page reload usually)
            });
        });
    </script>
@endpush
