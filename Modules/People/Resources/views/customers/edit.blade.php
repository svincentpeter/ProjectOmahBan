                        ...
                        <div class="card shadow-sm mb-3">
                            <div class="card-header bg-white border-bottom">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h5 class="mb-0 font-weight-bold">Edit Informasi Customer</h5>
                                        <small class="text-muted">Perbarui data customer untuk transaksi penjualan</small>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('city') is-invalid @enderror"
                                                name="city" id="city" value="{{ old('city', $customer->city) }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control @error('country') is-invalid @enderror"
                                                ...
                                                <option value="Indonesia"
                                                    {{ old('country', $customer->country) == 'Indonesia' ? 'selected' : '' }}>
                                                    Indonesia</option>
                                                <option value="Malaysia"
                                                    {{ old('country', $customer->country) == 'Malaysia' ? 'selected' : '' }}>
                                                    Malaysia</option>
                                                <option value="Singapura"
                                                    {{ old('country', $customer->country) == 'Singapura' ? 'selected' : '' }}>
                                                    Singapura</option>
                                                <option value="Brunei"
                                                    {{ old('country', $customer->country) == 'Brunei' ? 'selected' : '' }}>
                                                    Brunei</option>
                                            </select>
                                            @error('country')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-0">
                                            ...
                                            <textarea class="form-control @error('address') is-invalid @enderror" name="address" id="address" rows="3"
                                                placeholder="Alamat lengkap customer (minimal 10 karakter)" required>{{ old('address', $customer->address) }}</textarea>
                                            @error('address')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3 p-3 bg-light rounded">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <small class="text-muted">
                                            <i class="cil-cart mr-1"></i> Total Penjualan
                                        </small>
                                        <strong class="text-primary">{{ $customer->sales->count() }} transaksi</strong>
                                    </div>
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <small class="text-muted">
                                        ...
                                        <strong
                                            class="text-success">{{ format_currency($customer->sales->sum('total_amount')) }}</strong>
                                    </div>
                                        ...
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div>
                                                ...
                                                <p class="mb-0 mt-1" style="font-size: 0.875rem;">
                                                    Customer ini memiliki <strong>{{ $customer->sales->count() }}</strong>
                                                    riwayat penjualan.
                                ...
                                <div class="d-grid gap-2">
                                    <button type="submit" class="btn btn-primary btn-lg">
                                        <i class="cil-save mr-1"></i> Update Customer
                                    </button>
