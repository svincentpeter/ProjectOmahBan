...
<head>
    ...
    <style>
    @page {
    /* Nota toko (perkiraan dari foto): 22cm x 9.5cm */
    size: 220mm 95mm;
    margin: 6mm; /* aman agar tidak mepet tepi */
}
    ...
    * { box-sizing: border-box; }
    ...
    body {
        ...
        line-height: 1.2;
        color: #000;
        overflow: hidden; /* bantu cegah page tambahan karena overflow kecil */
    }
    ...
    .address {
        margin-top: 4px;      /* dipadatkan */
        line-height: 1.25;    /* dipadatkan */
        font-size: 9.5px;     /* sedikit kecil agar muat 1 halaman */
    }

    /* Blok meta kanan */
    .meta { font-size: 9.8px; line-height: 1.35; }
    ...
    .meta .dotsline.short { min-width: 26mm; }

    /* Tabel item */
    table.items {
        width: 100%;
        border-collapse: collapse;
        margin-top: 5px;              /* dipadatkan */
        page-break-inside: avoid;
    }
    ...
    table.items td {
        ...
        padding: 2px 3px;             /* dipadatkan (ini yang paling ngaruh) */
        font-size: 9.6px;             /* dipadatkan */
        line-height: 1.15;            /* dipadatkan */
    }
    ...
    /* TOTAL: jangan float (ini sering bikin tanda tangan pindah ke page 2) */
    table.total-box {
        border-collapse: collapse;
        float: none;                /* penting */
        margin-top: 2.5mm;
        margin-left: auto;          /* tetap nempel kanan tanpa float */
        page-break-inside: avoid;
    }
    ...
    /* Tanda tangan: dipadatkan dan dipaksa tetap di halaman yang sama */
    .sign {
        margin-top: 5mm;            /* dipadatkan dari 9mm */
        width: 75%;
        page-break-inside: avoid;
        page-break-before: avoid;
        clear: none;                /* penting: jangan pakai clear:both */
    }
