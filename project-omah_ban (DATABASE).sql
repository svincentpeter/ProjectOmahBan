...
CREATE DEFINER=`root`@`localhost` PROCEDURE `drop_index_if_exists` (IN `p_table` VARCHAR(64), IN `p_index` VARCHAR(64))
BEGIN
IF EXISTS (
...
INSERT INTO `fontee_config` (`id`, `config_key`, `config_value`, `description`, `is_active`, `created_at`, `updated_at`)
VALUES
(1, 'fontee_api_key', 'YOUR_FONTEE_API_KEY_HERE', 'API Key dari Fontee Dashboard', 0, '2025-11-05 08:41:27', '2025-11-05
08:41:27'),
(2, 'fontee_channel_id', 'YOUR_CHANNEL_ID', 'Channel ID untuk WhatsApp/SMS', 0, '2025-11-05 08:41:27', '2025-11-05
08:41:27'),
(3, 'fontee_webhook_secret', 'YOUR_WEBHOOK_SECRET', 'Secret key untuk webhook validation', 0, '2025-11-05 08:41:27',
'2025-11-05 08:41:27'),
(4, 'fontee_enabled', '1', 'Enable/disable Fontee integration', 1, '2025-11-05 08:41:27', '2025-11-05 08:41:27'),
(5, 'fontee_notification_type', 'whatsapp', 'Tipe notifikasi: whatsapp, sms, or both', 1, '2025-11-05 08:41:27',
'2025-11-05 08:41:27'),
...
`created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
`updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Detail tracking item manual untuk audit &
reporting';
...
INSERT INTO `manual_input_details` (`id`, `sale_id`, `sale_detail_id`, `cashier_id`, `item_type`, `item_name`,
`quantity`, `price`, `manual_reason`, `cost_price`, `created_at`, `updated_at`) VALUES
...
`input_type` enum('manual_item','manual_service','price_override','discount_applied') CHARACTER SET utf8mb4 COLLATE
utf8mb4_unicode_ci NOT NULL DEFAULT 'manual_item',
`item_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
`quantity` int UNSIGNED NOT NULL,
...
`approval_status` enum('pending','approved','rejected') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT
'pending',
...
`created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
`updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Audit trail lengkap untuk setiap input
...
INSERT INTO `manual_input_logs` (`id`, `sale_id`, `sale_detail_id`, `cashier_id`, `input_type`, `item_name`, `quantity`,
`standard_price`, `input_price`, `price_variance`, `variance_percent`, `reason_provided`, `supervisor_pin_required`,
`supervisor_id`, `approval_status`, `approval_notes`, `owner_notified`, `owner_notification_id`, `owner_notified_at`,
`created_at`, `updated_at`) VALUES
(1, 1, 1, 5, 'price_override', 'EP150 185/65 R15', 1, 925000, 900000, -25000, -2.7, 'Diskon loyal pelanggan', 1, 4,
'approved', 'OK by supervisor', 0, NULL, NULL, '2025-11-06 19:05:10', '2025-11-06 19:05:10'),
(2, 2, 2, 5, 'manual_service', 'Balancing', 1, NULL, 20000, NULL, NULL, 'Input manual awal', 0, NULL, 'pending', NULL,
0, NULL, NULL, '2025-11-06 19:10:25', '2025-11-06 19:10:25'),
(3, 2, 2, 5, 'price_override', 'Balancing', 1, 20000, 25000, 5000, 25, 'SUV balancing (beban kerja lebih)', 1, 4,
'approved', 'Disetujui atasan', 1, 2, '2025-11-06 19:20:20', '2025-11-06 19:18:05', '2025-11-06 19:20:20'),
(5, 4, 5, 5, 'manual_service', 'Jasa Pasang Ban', 1, NULL, 30000, NULL, NULL, 'Pemasangan', 0, NULL, 'pending', NULL, 0,
NULL, NULL, '2025-11-06 19:40:06', '2025-11-06 19:40:06'),
...
`created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
`updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Pre-calculated summary harian untuk
dashboard performa';
...
`notification_type` enum('manual_input_alert','price_adjustment','discount_alert','high_value_transaction') CHARACTER
SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'manual_input_alert',
...
`fontee_message_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'ID dari Fontee
API',
`fontee_status` enum('pending','sent','failed','read') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT
'pending',
...
`updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
`deleted_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Log semua notifikasi untuk owner terhadap
input manual & aktivitas penting';

--
-- Dumping data for table `owner_notifications`
--

INSERT INTO `owner_notifications` (`id`, `user_id`, `sale_id`, `notification_type`, `title`, `message`, `data`,
`severity`, `is_read`, `is_reviewed`, `read_at`, `reviewed_at`, `reviewed_by`, `review_notes`, `fontee_message_id`,
`fontee_status`, `fontee_sent_at`, `fontee_error_message`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 1, 1, 'price_adjustment', '✅ Penyesuaian Harga - Inv OB2-00001', 'Harga EP150 disesuaikan dari Rp 925.000 menjadi Rp
900.000 (-2.70%).', '{\"items\": [{\"qty\": 1, \"name\": \"EP150 185/65 R15\", \"price\": 900000}], \"cashier_id\": 5,
\"invoice_no\": \"OB2-00001\", \"cashier_name\": \"Ani (Kasir 1)\"}', 'info', 1, 0, '2025-11-08 06:09:39', NULL, NULL,
NULL, NULL, 'sent', NULL, NULL, '2025-11-06 19:06:00', '2025-11-08 06:09:39', NULL),
(2, 1, 2, 'manual_input_alert', '⚠️ Input Manual Disesuaikan - Inv OB2-00002', 'Balancing naik dari Rp 20.000 ➜ Rp
25.000 (approved).', '{\"items\": [{\"name\": \"Balancing\", \"type\": \"service\", \"price\": 25000, \"reason\": \"Velg
besar\", \"quantity\": 1}], \"cashier_id\": 5, \"invoice_no\": \"OB2-00002\", \"items_count\": 1, \"cashier_name\":
\"Ani (Kasir 1)\", \"total_amount\": 25000}', 'info', 0, 0, NULL, NULL, NULL, NULL, NULL, 'sent', NULL, NULL,
'2025-11-06 19:20:25', '2025-11-06 19:20:25', NULL),
(3, 1, 4, 'manual_input_alert', '⚠️ Input Manual (2 item) - Inv OB2-00004', 'Transaksi memuat 2 item manual: Jasa Pasang
Ban (30.000), Nitrogen (8.000).', '{\"items\": [{\"name\": \"Jasa Pasang Ban\", \"type\": \"service\", \"price\": 30000,
\"quantity\": 1}, {\"name\": \"Nitrogen\", \"type\": \"goods\", \"price\": 8000, \"quantity\": 1}], \"cashier_id\": 5,
\"invoice_no\": \"OB2-00004\", \"items_count\": 2, \"cashier_name\": \"Ani (Kasir 1)\", \"total_amount\": 38000}',
'warning', 0, 0, NULL, NULL, NULL, NULL, NULL, 'sent', NULL, NULL, '2025-11-06 19:40:12', '2025-11-06 19:40:12', NULL),
(4, 1, 6, 'manual_input_alert', '⚠️ Input Manual - Inv OB2-00005', 'Kasir Ani (Kasir 1) membuat transaksi dengan 1 item
input manual:\n\nNgetestt (1x @ Rp 22.222)\n\nTotal: Rp 22.222\nInvoice: OB2-00005\nWaktu: 07-11-2025 13:52:09',
...
(5, 2, 6, 'manual_input_alert', '⚠️ Input Manual - Inv OB2-00005', 'Kasir Ani (Kasir 1) membuat transaksi dengan 1 item
input manual:\n\nNgetestt (1x @ Rp 22.222)\n\nTotal: Rp 22.222\nInvoice: OB2-00005\nWaktu: 07-11-2025 13:52:09',
'{\"items\": [{\"name\": \"Ngetestt\", \"type\": \"service\", \"price\": 22222, \"reason\": \"TWESTTTTTINFGGGGG\",
\"quantity\": 1}], \"cashier_id\": 5, \"invoice_no\": \"OB2-00005\", \"items_count\": 1, \"cashier_name\": \"Ani (Kasir
1)\", \"total_amount\": 22222}', 'info', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-11-07 06:52:09',
'2025-11-07 06:52:09', NULL),
(6, 3, 6, 'manual_input_alert', '⚠️ Input Manual - Inv OB2-00005', 'Kasir Ani (Kasir 1) membuat transaksi dengan 1 item
input manual:\n\nNgetestt (1x @ Rp 22.222)\n\nTotal: Rp 22.222\nInvoice: OB2-00005\nWaktu: 07-11-2025 13:52:09',
'{\"items\": [{\"name\": \"Ngetestt\", \"type\": \"service\", \"price\": 22222, \"reason\": \"TWESTTTTTINFGGGGG\",
\"quantity\": 1}], \"cashier_id\": 5, \"invoice_no\": \"OB2-00005\", \"items_count\": 1, \"cashier_name\": \"Ani (Kasir
1)\", \"total_amount\": 22222}', 'info', 1, 1, '2025-11-07 07:18:39', '2025-11-07 07:18:41', NULL, NULL, NULL, NULL,
NULL, NULL, '2025-11-07 06:52:09', '2025-11-07 07:18:41', NULL),
(7, 4, 6, 'manual_input_alert', '⚠️ Input Manual - Inv OB2-00005', 'Kasir Ani (Kasir 1) membuat transaksi dengan 1 item
input manual:\n\nNgetestt (1x @ Rp 22.222)\n\nTotal: Rp 22.222\nInvoice: OB2-00005\nWaktu: 07-11-2025 13:52:09',
'{\"items\": [{\"name\": \"Ngetestt\", \"type\": \"service\", \"price\": 22222, \"reason\": \"TWESTTTTTINFGGGGG\",
\"quantity\": 1}], \"cashier_id\": 5, \"invoice_no\": \"OB2-00005\", \"items_count\": 1, \"cashier_name\": \"Ani (Kasir
1)\", \"total_amount\": 22222}', 'info', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-11-07 06:52:09',
...
`product_year`) VALUES
(1, 1, 2, 'Ban GT Savero', 'GT_Savero', 51, 5, 1280760, 1425000, 'PC', 2, NULL, NULL, NULL, '2025-08-06 02:17:51',
...
1800000, 2250000, 'available', '2025-08-17 05:04:07', '2025-08-17 05:24:47', NULL, 3, 4, NULL, '16', 2022),
...
`manual_input_summary` json DEFAULT NULL COMMENT 'Summary item manual: [{"name":"...", "qty":1, "price":...,
"reason":"..."}]',
...
(1, 1, 'Ban Bridgestone Ecopia EP150 185/65 R15', 2, NULL, NULL, 'new', NULL, 'Ban Bridgestone Ecopia EP150 185/65 R15',
'BS-EP150-18565R15', 1, 900000, 925000, 1, 25000, 'Diskon loyal pelanggan', 5, '2025-11-06 19:05:00', 725000, NULL,
900000, 900000, 175000, 0, 'fixed', 0, '2025-11-06 19:00:00', '2025-11-06 19:20:00'),
(2, 2, 'Balancing', NULL, NULL, NULL, 'manual', 'service', 'Balancing', 'SRV-BAL', 1, 25000, 20000, 1, -5000, 'SUV
balancing (butuh waktu & beban lebih)', 4, '2025-11-06 19:18:00', 0, 0, 25000, 25000, 25000, 0, 'fixed', 0, '2025-11-06
19:10:10', '2025-11-06 19:10:10'),
(3, 3, 'GT Champiro Eco 195/65 R15', 4, NULL, NULL, 'new', NULL, 'GT Champiro Eco 195/65 R15', 'GT-CE-19565R15', 1,
835000, 835000, 0, 0, NULL, NULL, NULL, 640000, NULL, 835000, 835000, 195000, 0, 'fixed', 0, '2025-11-06 19:30:10',
'2025-11-06 19:30:10'),
(5, 4, 'Jasa Pasang Ban', NULL, NULL, NULL, 'manual', 'service', 'Jasa Pasang Ban', 'SRV-PASANG', 1, 30000, 30000, 0, 0,
NULL, NULL, NULL, 0, 0, 30000, 30000, 30000, 0, 'fixed', 0, '2025-11-06 19:40:05', '2025-11-06 19:40:05'),
...
IF NEW.price IS NULL OR NEW.price < 0 THEN SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT='price wajib diisi dan >= 0' ; END
    IF; IF NEW.quantity IS NULL OR NEW.quantity < 1 THEN SET NEW.quantity=1; END IF; IF NEW.unit_price IS NULL OR
    NEW.unit_price=0 THEN SET NEW.unit_price=NEW.price; END IF; IF NEW.sub_total IS NULL OR NEW.sub_total=0 THEN SET
    NEW.sub_total=NEW.unit_price * NEW.quantity; END IF; -- Deteksi JASA (ServiceMaster) → paksa jadi manual/service IF
    NEW.productable_type IN ('Modules\Product\Entities\ServiceMaster','ModulesProductEntitiesServiceMaster') OR
    LEFT(NEW.product_code,4)='SRV-' THEN SET NEW.source_type='manual' ; SET
    NEW.manual_kind=IFNULL(NEW.manual_kind, 'service' ); END IF; -- Validasi per sumber IF NEW.source_type='new' THEN IF
    NEW.product_id IS NULL OR NEW.product_id=0 THEN SIGNAL SQLSTATE '45000' SET
    MESSAGE_TEXT='Produk Baru: product_id wajib' ; END IF; -- untuk produk baru: tidak pakai productable SET
    NEW.productable_id=NULL; SET NEW.productable_type=NULL; SET NEW.manual_kind=NULL; ELSEIF NEW.source_type='second'
    THEN SET NEW.quantity=1; -- unit second selalu 1 IF NEW.productable_id IS NULL OR NEW.productable_id=0 THEN SIGNAL
    SQLSTATE '45000' SET MESSAGE_TEXT='Produk Second: productable_id wajib' ; END IF; IF NOT EXISTS ( SELECT 1 FROM
    product_seconds ps WHERE ps.id=NEW.productable_id AND ps.status='available' ) THEN SIGNAL SQLSTATE '45000' SET
    MESSAGE_TEXT='Produk Second: unit tidak available' ; END IF; SET NEW.product_id=NULL; SET NEW.manual_kind=NULL; ELSE
    -- manual (service/goods) SET NEW.source_type='manual' ; SET NEW.manual_kind=IFNULL(NEW.manual_kind, 'goods' ); --
    manual tidak memakai products.id SET NEW.product_id=NULL; -- catatan: sekarang kita IJINKAN simpan link ke master
    (productable_type/id) bila ada -- tidak ada movement stok utk manual, jadi aman END IF; END $$ DELIMITER ; DELIMITER
    $$ CREATE TRIGGER `trg_sale_details_chk_bu` BEFORE UPDATE ON `sale_details` FOR EACH ROW BEGIN SET
    NEW.source_type=LOWER(IFNULL(NEW.source_type, '' )); IF NEW.price IS NULL OR NEW.price < 0 THEN SIGNAL
    SQLSTATE '45000' SET MESSAGE_TEXT='price wajib diisi dan >= 0 (UPDATE)' ; END IF; IF NEW.quantity IS NULL OR
    NEW.quantity < 1 THEN SET NEW.quantity=1; END IF; IF NEW.unit_price IS NULL OR NEW.unit_price=0 THEN SET
    NEW.unit_price=NEW.price; END IF; IF NEW.sub_total IS NULL OR NEW.sub_total=0 THEN SET NEW.sub_total=NEW.unit_price
    * NEW.quantity; END IF; -- Deteksi JASA → paksa manual/service IF NEW.productable_type IN
    ('Modules\Product\Entities\ServiceMaster','ModulesProductEntitiesServiceMaster') OR LEFT(NEW.product_code,4)='SRV-'
    THEN SET NEW.source_type='manual' ; SET NEW.manual_kind=IFNULL(NEW.manual_kind, 'service' ); END IF; IF
    NEW.source_type='new' THEN IF NEW.product_id IS NULL OR NEW.product_id=0 THEN SIGNAL SQLSTATE '45000' SET
    MESSAGE_TEXT='Produk Baru: product_id wajib (UPDATE)' ; END IF; SET NEW.productable_id=NULL; SET
    NEW.productable_type=NULL; SET NEW.manual_kind=NULL; ELSEIF NEW.source_type='second' THEN SET NEW.quantity=1; IF
    NEW.productable_id IS NULL OR NEW.productable_id=0 THEN SIGNAL SQLSTATE '45000' SET
        ...
        OR (IFNULL(OLD.product_id,0) <> IFNULL(NEW.product_id,0))
            OR (IFNULL(OLD.productable_id,0) <> IFNULL(NEW.productable_id,0))
                OR (OLD.quantity <> NEW.quantity) THEN
                    ...
                    IF NEW.quantity IS NULL OR NEW.quantity < 1 THEN SET NEW.quantity=1; END IF; SELECT product_quantity
                        INTO v_qty FROM products WHERE id=NEW.product_id LIMIT 1; IF v_qty IS NULL THEN SIGNAL
                        SQLSTATE '45000' SET MESSAGE_TEXT='Produk Baru: produk tidak ditemukan' ; END IF; IF v_qty <
                        NEW.quantity THEN SIGNAL SQLSTATE '45000' SET
                        MESSAGE_TEXT='Stok tidak mencukupi (BEFORE INSERT)' ; END IF; ELSEIF NEW.source_type='second'
                        THEN SET NEW.quantity=1; SELECT COUNT(*) INTO v_exists FROM product_seconds ps WHERE
                        ps.id=NEW.productable_id AND ps.status='available' ; IF v_exists=0 THEN SIGNAL SQLSTATE '45000'
                        SET MESSAGE_TEXT='Produk Second: unit tidak available' ; END IF; ELSE /* manual */ SET
                        NEW.quantity=1; END IF; END $$ DELIMITER ; DELIMITER $$ CREATE TRIGGER `trg_sd_stock_guard_bu`
                        BEFORE UPDATE ON `sale_details` FOR EACH ROW BEGIN DECLARE v_old INT DEFAULT 0; DECLARE v_new
                        INT DEFAULT 0; DECLARE v_stock INT DEFAULT 0; DECLARE v_stock_new INT DEFAULT 0; DECLARE
                        v_stock_old INT DEFAULT 0; DECLARE v_exists INT DEFAULT 0; /* normalisasi */ SET
                        NEW.source_type=LOWER(NEW.source_type); IF NEW.source_type='new' THEN SET
                        v_old=IFNULL(OLD.quantity,0); SET v_new=IFNULL(NEW.quantity,0); IF NEW.product_id IS NULL OR
                        NEW.product_id=0 THEN SIGNAL SQLSTATE '45000' SET
                        MESSAGE_TEXT='Produk Baru: product_id wajib (UPDATE)' ; END IF; IF v_new < 1 THEN SET
                        NEW.quantity=1; SET v_new=1; END IF; IF NEW.product_id=OLD.product_id THEN SELECT
                        product_quantity INTO v_stock FROM products WHERE id=NEW.product_id; /* setelah revert v_old dan
                        apply v_new, stok tidak boleh minus */ IF v_stock + v_old - v_new < 0 THEN SIGNAL
                        SQLSTATE '45000' SET MESSAGE_TEXT='Stok tidak cukup setelah UPDATE' ; END IF; ELSE /* ganti
                        produk: cek stok produk baru, dan produk lama akan direvert di AFTER */ SELECT product_quantity
                        INTO v_stock_new FROM products WHERE id=NEW.product_id; IF v_stock_new - v_new < 0 THEN SIGNAL
                        SQLSTATE '45000' SET MESSAGE_TEXT='Stok tidak cukup (produk baru) setelah UPDATE' ; END IF; END
                        IF; ELSEIF NEW.source_type='second' THEN SET NEW.quantity=1; IF NEW.productable_id <>
                        OLD.productable_id THEN
                        ...
                        INSERT INTO `sale_payments` (`id`, `sale_id`, `amount`, `date`, `reference`, `payment_method`,
                        `bank_name`, `note`, `created_at`, `updated_at`, `deleted_at`) VALUES
                        (36, 6, 22222, '2025-11-07', 'INV/OB2-00005', 'QRIS', NULL, NULL, '2025-11-07 06:52:15',
                        '2025-11-07 06:52:15', NULL);
                        ...
                        `id` bigint UNSIGNED NOT NULL,
                        `service_name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Nama jasa: Pasang Ban,
                        Balancing, dll',
                        `standard_price` bigint UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Harga standar (dalam rupiah)',
                        `category` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'service' COMMENT 'Kategori:
                        service|goods|custom',
                        ...
                        `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
                        `deleted_at` timestamp NULL DEFAULT NULL
                        ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Master data jasa
                        ...
                        INSERT INTO `service_masters` (`id`, `service_name`, `standard_price`, `category`,
                        `description`, `status`, `price_before`, `price_after`, `price_updated_at`, `updated_by`,
                        `created_by`, `created_at`, `updated_at`, `deleted_at`) VALUES
                        (1, 'Spooring Ban', 150000, 'service', 'Penstabilan Roda', 1, 150000, 150000, '2025-11-04
                        08:22:21', 1, NULL, '2025-11-04 07:26:02', '2025-11-04 08:22:21', NULL),
                        (2, 'Pasang Ban', 25000, 'service', NULL, 1, NULL, NULL, NULL, NULL, 9001, '2025-11-06
                        09:40:35', '2025-11-06 09:40:35', NULL),
                        (3, 'Balancing', 20000, 'service', NULL, 1, NULL, NULL, NULL, NULL, 9001, '2025-11-06 09:40:35',
                        '2025-11-06 09:40:35', NULL);
                        ...
                        `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
                        `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
                        ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Audit log perubahan
                        harga standar jasa';
                        ...
                        INSERT INTO `service_master_audits` (`id`, `service_master_id`, `old_price`, `new_price`,
                        `reason`, `changed_by`, `created_at`, `updated_at`) VALUES
                        ...
                        `default_currency_position` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT
                        NULL,
                        ...
                        `notification_email`, `footer_text`, `company_address`, `created_at`, `updated_at`) VALUES
                        (1, 'Omah Ban 2', 'vincentpeter789@gmail.com', '085325579921', NULL, 1, 'prefix', '.', ',',
                        'vincentpeter789@gmail.com', 'Triangle Pos © 2021 || Developed by <strong><a target=\"_blank\"
                                href=\"https://fahimanzam.me\">Fahim Anzam</a></strong>', 'Jl. Empu Sendok 2A, Gedawang
                        (Banyumanik), Semarang', '2025-08-05 14:46:12', '2025-09-08 08:30:37');
                        ...
                        `updated_at` timestamp NULL DEFAULT NULL,
                        `deleted_at` timestamp NULL DEFAULT NULL,
                        `out_key` varchar(255) COLLATE utf8mb4_unicode_ci GENERATED ALWAYS AS ((case when (`type` =
                        _utf8mb4'out') then concat(`productable_type`,_utf8mb4'#',`productable_id`) else NULL end))
                        STORED,
                        `second_out_key` varchar(255) COLLATE utf8mb4_unicode_ci GENERATED ALWAYS AS ((case when
                        ((`type` = _utf8mb4'out') and (`productable_type` =
                        _utf8mb4'Modules\\Product\\Entities\\ProductSecond')) then
                        concat(`productable_type`,_utf8mb4'#',`productable_id`) else NULL end)) STORED
                        ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
                        ...
                        INSERT INTO `stock_movements` (`id`, `productable_type`, `productable_id`, `product_id`,
                        `ref_id`, `ref_type`, `type`, `quantity`, `description`, `user_id`, `created_at`, `updated_at`,
                        `deleted_at`) VALUES
                        (11, NULL, NULL, 2, 5, 'adjustment', 'out', 3, 'Adjustment ADJ-20251102-00001 - sub', 2,
                        '2025-11-02 10:18:26', '2025-11-02 10:18:26', NULL),
                        (16, 'Modules\\Product\\Entities\\Product', 4, NULL, NULL, 'adjustment', 'out', 1, 'Sale
                        OB2-00089', 5, '2025-11-06 10:43:05', '2025-11-06 10:43:05', NULL),
                        (17, 'Modules\\Product\\Entities\\Product', 4, NULL, NULL, 'adjustment', 'out', 1, 'Sale
                        #OB2-00089', 5, '2025-11-06 09:43:29', '2025-11-06 09:43:29', NULL),
                        (18, 'Modules\\Product\\Entities\\Product', 1, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        SL-00001', NULL, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (19, 'Modules\\Product\\Entities\\Product', 1, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        SL-00005', NULL, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (20, 'Modules\\Product\\Entities\\Product', 1, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        SL-00020', NULL, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (21, 'Modules\\Product\\Entities\\Product', 1, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        SL-00021', NULL, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (22, 'Modules\\Product\\Entities\\Product', 1, NULL, NULL, 'adjustment', 'in', 4, 'Revert sale
                        SL-00022', NULL, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (23, 'Modules\\Product\\Entities\\Product', 1, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        SL-00023', NULL, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (24, 'Modules\\Product\\Entities\\Product', 1, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        SL-00024', NULL, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (25, 'Modules\\Product\\Entities\\Product', 1, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        SL-00025', NULL, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (26, 'Modules\\Product\\Entities\\Product', 1, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        SL-00027', NULL, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (27, 'Modules\\Product\\Entities\\Product', 1, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        SL-00028', NULL, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (28, 'Modules\\Product\\Entities\\Product', 1, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        SL-00029', NULL, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (29, 'Modules\\Product\\Entities\\Product', 1, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        SL-00030', NULL, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (30, 'Modules\\Product\\Entities\\Product', 1, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        SL-00031', NULL, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (31, 'Modules\\Product\\Entities\\Product', 1, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        SL-00032', NULL, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (32, 'Modules\\Product\\Entities\\Product', 1, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        SL-00033', NULL, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (33, 'Modules\\Product\\Entities\\Product', 1, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        SL-00034', NULL, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (34, 'Modules\\Product\\Entities\\Product', 1, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        SL-00035', NULL, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (35, 'Modules\\Product\\Entities\\Product', 1, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        SL-00036', NULL, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (36, 'Modules\\Product\\Entities\\Product', 1, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        SL-00037', NULL, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (37, 'Modules\\Product\\Entities\\Product', 1, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        SL-00041', 1, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (38, 'Modules\\Product\\Entities\\Product', 1, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        SL-00045', 1, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (39, 'Modules\\Product\\Entities\\Product', 1, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        SL-00048', 1, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (40, 'Modules\\Product\\Entities\\Product', 1, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        SL-00049', 1, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (41, 'Modules\\Product\\Entities\\Product', 1, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        SL-00050', 1, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (42, 'Modules\\Product\\Entities\\Product', 1, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        SL-00051', 1, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (43, 'Modules\\Product\\Entities\\Product', 1, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        SL-00052', 1, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (44, 'Modules\\Product\\Entities\\Product', 1, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        SL-00054', 1, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (45, 'Modules\\Product\\Entities\\ProductSecond', 3, NULL, NULL, 'adjustment', 'in', 1, 'Revert
                        sale SL-00055', 1, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (46, 'Modules\\Product\\Entities\\Product', 1, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        SL-00057', 1, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (47, 'Modules\\Product\\Entities\\Product', 1, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        SL-00056', 1, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (48, 'Modules\\Product\\Entities\\ProductSecond', 2, NULL, NULL, 'adjustment', 'in', 1, 'Revert
                        sale SL-20250820-202448-68a5dab0793ff', NULL, '2025-11-07 04:43:16', '2025-11-07 04:43:16',
                        NULL),
                        (49, 'Modules\\Product\\Entities\\ProductSecond', 1, NULL, NULL, 'adjustment', 'in', 1, 'Revert
                        sale OB2-00060', NULL, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (50, 'Modules\\Product\\Entities\\Product', 1, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        OB2-00061', 1, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (51, 'Modules\\Product\\Entities\\Product', 1, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        OB2-00064', 1, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (52, 'Modules\\Product\\Entities\\Product', 4, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        OB2-00065', 1, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (53, 'Modules\\Product\\Entities\\Product', 2, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        OB2-00066', 1, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (54, 'Modules\\Product\\Entities\\Product', 4, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        OB2-00067', 2, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (55, 'Modules\\Product\\Entities\\Product', 4, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        OB2-00068', 2, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (56, 'Modules\\Product\\Entities\\Product', 1, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        OB2-00069', 2, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (57, 'Modules\\Product\\Entities\\Product', 2, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        OB2-00070', 2, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (58, 'Modules\\Product\\Entities\\Product', 2, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        OB2-00071', 2, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (59, 'Modules\\Product\\Entities\\Product', 4, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        OB2-00072', 2, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (60, 'Modules\\Product\\Entities\\Product', 4, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        OB2-00073', 2, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (61, 'Modules\\Product\\Entities\\Product', 3, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        OB2-00074', 2, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (62, 'Modules\\Product\\Entities\\Product', 4, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        OB2-00075', 2, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (63, 'Modules\\Product\\Entities\\Product', 2, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        OB2-00077', 1, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (64, 'Modules\\Product\\Entities\\Product', 4, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        OB2-00078', 1, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (65, 'Modules\\Product\\Entities\\Product', 4, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        OB2-00079', 1, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (66, 'Modules\\Product\\Entities\\Product', 4, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        OB2-00080', 1, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (67, 'Modules\\Product\\Entities\\Product', 3, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        OB2-00081', 1, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (68, 'Modules\\Product\\Entities\\Product', 2, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        OB2-00082', 1, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (69, 'Modules\\Product\\Entities\\Product', 2, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        OB2-00083', 1, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (70, 'Modules\\Product\\Entities\\Product', 1, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        OB2-00084', 1, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (71, 'Modules\\Product\\Entities\\ProductSecond', 4, NULL, NULL, 'adjustment', 'in', 1, 'Revert
                        sale OB2-00085', 1, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (72, 'Modules\\Product\\Entities\\Product', 4, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        OB2-00089', 5, '2025-11-07 04:43:16', '2025-11-07 04:43:16', NULL),
                        (74, 'Modules\\Product\\Entities\\Product', 2, NULL, NULL, 'adjustment', 'out', 1, 'Sale
                        OB2-00001', 5, '2025-11-07 04:48:10', '2025-11-07 04:48:10', NULL),
                        (75, 'Modules\\Product\\Entities\\Product', 2, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        OB2-00001', 5, '2025-11-07 04:48:42', '2025-11-07 04:48:42', NULL),
                        (76, 'Modules\\Product\\Entities\\Product', 2, NULL, NULL, 'adjustment', 'out', 1, 'Sale
                        OB2-00001', 5, '2025-11-07 04:53:14', '2025-11-07 04:53:14', NULL),
                        (77, 'Modules\\Product\\Entities\\Product', 4, NULL, NULL, 'adjustment', 'out', 1, 'Sale
                        OB2-00003', 5, '2025-11-07 04:53:26', '2025-11-07 04:53:26', NULL),
                        (78, 'Modules\\Product\\Entities\\Product', 2, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        OB2-00001', 5, '2025-11-07 07:35:14', '2025-11-07 07:35:14', NULL),
                        (79, 'Modules\\Product\\Entities\\Product', 4, NULL, NULL, 'adjustment', 'in', 1, 'Revert sale
                        OB2-00003', 5, '2025-11-07 07:35:14', '2025-11-07 07:35:14', NULL),
                        ...
                        INSERT INTO `units` (`id`, `name`, `short_name`, `operator`, `operation_value`, `created_at`,
                        `updated_at`) VALUES
                        ...
                        `supervisor_pin` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'PIN 6 digit
                        encrypted',
                        ...
                        INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `supervisor_pin`,
                        `phone_number`, `last_login_at`, `login_ip`, `is_active`, `remember_token`, `created_at`,
                        `updated_at`, `deleted_at`) VALUES
                        (1, 'Administrator', 'super.admin@test.com', NULL,
                        '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', NULL, NULL, NULL, NULL, 1, NULL,
                        '2025-08-05 14:46:12', '2025-08-05 14:46:12', NULL),
                        (2, 'Vincent Peter', 'peter@gmail.com', NULL,
                        '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',
                        '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWWG/igi', NULL, NULL, NULL, 1,
                        '5hZ3CWkyl8cCit1tNc7qtR0WHhW2RiXxgg7HiCAYa3BaDy5mOTE0VmQZ00AY', '2025-09-30 13:32:44',
                        '2025-09-30 13:32:44', NULL),
                        (3, 'Budi (Owner)', 'budi.owner@omahban.test', NULL,
                        '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', NULL, '08123456789', NULL, NULL,
                        1, NULL, '2025-11-01 04:20:39', '2025-11-01 04:20:39', NULL),
                        (4, 'Siti (Supervisor)', 'siti.sup@omahban.test', NULL,
                        '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', NULL, '08198765432', NULL, NULL,
                        1, NULL, '2025-11-01 04:20:39', '2025-11-01 04:20:39', NULL),
                        (5, 'Ani (Kasir 1)', 'ani.kasir@omahban.test', NULL,
                        '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', NULL, '08112233445', NULL, NULL,
                        1, NULL, '2025-11-01 04:20:39', '2025-11-01 04:20:39', NULL),
                        (6, 'Rina (Kasir 2)', 'rina.kasir@omahban.test', NULL,
                        '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', NULL, '08556677889', NULL, NULL,
                        1, NULL, '2025-11-01 04:20:39', '2025-11-01 04:20:39', NULL),
                        (9001, 'Owner OmahBan', 'owner@example.com', NULL, '$2y$10$hashdummy', NULL, NULL, NULL, NULL,
                        1, NULL, '2025-11-06 09:40:35', '2025-11-06 09:40:35', NULL),
                        (9002, 'Kasir Demo', 'kasir@example.com', NULL, '$2y$10$hashdummy', NULL, NULL, NULL, NULL, 1,
                        NULL, '2025-11-06 09:40:35', '2025-11-06 09:40:35', NULL),
                        (9003, 'Owner', 'owner@ob.test', NULL,
                        '$2y$10$OGGliCSV1Ksj.cl/IL5KfOMhUkYyuzGzJqsEN1CwB6tK1x2cMSVBu', NULL, NULL, NULL, NULL, 1, NULL,
                        '2025-11-06 13:42:16', '2025-11-06 13:42:16', NULL),
                        (9004, 'Kasir 1', 'kasir1@ob.test', NULL,
                        '$2y$10$D6H6R2B21KNGkbDOounpWOk6boBureT1hSDZnI8op.lUj9pe.BnKW', NULL, NULL, NULL, NULL, 1, NULL,
                        '2025-11-06 13:42:16', '2025-11-06 13:42:16', NULL);
                        ...
                        `action` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'create_invoice, void_sale,
                        override_price, dll',
                        ...
                        ALTER TABLE `products` ADD FULLTEXT KEY `ft_products_search`
                        (`product_name`,`product_code`,`product_size`,`ring`);
                        ...
                        ALTER TABLE `product_seconds` ADD FULLTEXT KEY `ft_product_seconds_search`
                        (`name`,`unique_code`,`size`,`ring`);
                        ...
                        ADD KEY `stock_movements_productable_type_productable_id_index`
                        ...
                        `categories_view` AS SELECT `c`.`id` AS `id`, `c`.`category_code` AS `category_code`,
                        `c`.`category_name` AS `name`, `c`.`created_at` AS `created_at`, `c`.`updated_at` AS
                        `updated_at` FROM `categories` AS `c` ;
                        ...
                        CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW
                        `v_adjustment_summary` AS SELECT `a`.`id` AS `adjustment_id`, `a`.`reference` AS `reference`,
                        `a`.`date` AS `date`, `a`.`status` AS `status`, `a`.`reason` AS `reason`, `a`.`total_value` AS
                        `total_value`, `req`.`name` AS `requester_name`, `appr`.`name` AS `approver_name`,
                        count(distinct `ap`.`product_id`) AS `total_products`, coalesce(sum(`ap`.`quantity`),0) AS
                        `total_items`, date_format(max(`al`.`created_at`),'%Y-%m-%d %H:%i:%s') AS `last_activity` FROM
                        ((((`adjustments` `a` left join `adjusted_products` `ap` on(((`ap`.`adjustment_id` = `a`.`id`)
                        and (`ap`.`deleted_at` is null)))) left join `adjustment_logs` `al` on(((`al`.`adjustment_id` =
                        `a`.`id`) and (`al`.`deleted_at` is null)))) left join `users` `req` on((`req`.`id` =
                        `a`.`requester_id`))) left join `users` `appr` on((`appr`.`id` = `a`.`approver_id`))) GROUP BY
                        `a`.`id` ;
                        ...
                        --
                        ALTER TABLE `adjusted_products`
                        ADD CONSTRAINT `fk_ap_adjustment` FOREIGN KEY (`adjustment_id`) REFERENCES `adjustments` (`id`)
                        ON DELETE CASCADE ON UPDATE CASCADE,
                        ADD CONSTRAINT `fk_ap_product` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE
                        ...
                        --
                        ALTER TABLE `adjustments`
                        ADD CONSTRAINT `adjustments_ibfk_1` FOREIGN KEY (`requester_id`) REFERENCES `users` (`id`) ON
                        DELETE SET NULL,
                        ADD CONSTRAINT `adjustments_ibfk_2` FOREIGN KEY (`approver_id`) REFERENCES `users` (`id`) ON
                        DELETE SET NULL,
                        ADD CONSTRAINT `fk_adj_appr` FOREIGN KEY (`approver_id`) REFERENCES `users` (`id`) ON DELETE SET
                        NULL ON UPDATE CASCADE,
                        ADD CONSTRAINT `fk_adj_req` FOREIGN KEY (`requester_id`) REFERENCES `users` (`id`) ON DELETE SET
                        NULL ON UPDATE CASCADE;
                        ...
                        --
                        ALTER TABLE `adjustment_files`
                        ADD CONSTRAINT `adjustment_files_ibfk_1` FOREIGN KEY (`adjustment_id`) REFERENCES `adjustments`
                        (`id`) ON DELETE CASCADE,
                        ADD CONSTRAINT `fk_adjfile_adj` FOREIGN KEY (`adjustment_id`) REFERENCES `adjustments` (`id`) ON
                        ...
                        --
                        ALTER TABLE `adjustment_logs`
                        ADD CONSTRAINT `fk_adjl_adjustment` FOREIGN KEY (`adjustment_id`) REFERENCES `adjustments`
                        (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
                        ADD CONSTRAINT `fk_adjl_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE SET
                        NULL ON UPDATE CASCADE,
                        ADD CONSTRAINT `fk_adjlog_adj` FOREIGN KEY (`adjustment_id`) REFERENCES `adjustments` (`id`) ON
                        DELETE CASCADE ON UPDATE CASCADE,
                        ADD CONSTRAINT `fk_adjlog_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE SET
                        NULL ON UPDATE CASCADE;
                        ...
                        --
                        ALTER TABLE `expenses`
                        ADD CONSTRAINT `expenses_category_id_foreign` FOREIGN KEY (`category_id`) REFERENCES
                        `expense_categories` (`id`) ON DELETE RESTRICT,
                        ADD CONSTRAINT `expenses_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON
                        DELETE SET NULL,
                        ADD CONSTRAINT `fk_exp_cat` FOREIGN KEY (`category_id`) REFERENCES `expense_categories` (`id`)
                        ON DELETE RESTRICT ON UPDATE CASCADE,
                        ADD CONSTRAINT `fk_exp_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE SET
                        NULL ON UPDATE CASCADE;
                        ...
                        --
                        ALTER TABLE `manual_input_details`
                        ADD CONSTRAINT `fk_mid_cashier` FOREIGN KEY (`cashier_id`) REFERENCES `users` (`id`) ON DELETE
                        RESTRICT ON UPDATE CASCADE,
                        ADD CONSTRAINT `fk_mid_sale` FOREIGN KEY (`sale_id`) REFERENCES `sales` (`id`) ON DELETE CASCADE
                        ON UPDATE CASCADE,
                        ADD CONSTRAINT `fk_mid_sale_detail` FOREIGN KEY (`sale_detail_id`) REFERENCES `sale_details`
                        (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
                        ...
                        --
                        ALTER TABLE `manual_input_logs`
                        ADD CONSTRAINT `fk_mil_cashier` FOREIGN KEY (`cashier_id`) REFERENCES `users` (`id`) ON DELETE
                        RESTRICT,
                        ADD CONSTRAINT `fk_mil_notification` FOREIGN KEY (`owner_notification_id`) REFERENCES
                        `owner_notifications` (`id`) ON DELETE SET NULL,
                        ADD CONSTRAINT `fk_mil_sale` FOREIGN KEY (`sale_id`) REFERENCES `sales` (`id`) ON DELETE
                        CASCADE,
                        ADD CONSTRAINT `fk_mil_sale_detail` FOREIGN KEY (`sale_detail_id`) REFERENCES `sale_details`
                        (`id`) ON DELETE CASCADE,
                        ADD CONSTRAINT `fk_mil_supervisor` FOREIGN KEY (`supervisor_id`) REFERENCES `users` (`id`) ON
                        DELETE SET NULL,
                        ADD CONSTRAINT `fk_milog_sale_detail` FOREIGN KEY (`sale_detail_id`) REFERENCES `sale_details`
                        ...
                        --
                        ALTER TABLE `manual_input_summary_daily`
                        ADD CONSTRAINT `fk_misd_cashier` FOREIGN KEY (`cashier_id`) REFERENCES `users` (`id`) ON DELETE
                        CASCADE;
                        ...
                        --
                        ALTER TABLE `model_has_roles`
                        ADD CONSTRAINT `model_has_roles_role_id_foreign` FOREIGN KEY (`role_id`) REFERENCES `roles`
                        (`id`) ON DELETE CASCADE;
                        ...
                        --
                        ALTER TABLE `products`
                        ADD CONSTRAINT `fk_prod_brand` FOREIGN KEY (`brand_id`) REFERENCES `brands` (`id`) ON DELETE SET
                        NULL ON UPDATE CASCADE,
                        ADD CONSTRAINT `fk_prod_cat` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON
                        DELETE RESTRICT ON UPDATE CASCADE,
                        ADD CONSTRAINT `products_brand_id_foreign` FOREIGN KEY (`brand_id`) REFERENCES `brands` (`id`)
                        ON DELETE SET NULL,
                        ADD CONSTRAINT `products_category_id_foreign` FOREIGN KEY (`category_id`) REFERENCES
                        ...
                        --
                        ALTER TABLE `product_seconds`
                        ADD CONSTRAINT `fk_ps_brand` FOREIGN KEY (`brand_id`) REFERENCES `brands` (`id`) ON DELETE SET
                        NULL ON UPDATE CASCADE,
                        ADD CONSTRAINT `fk_ps_cat` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE
                        SET NULL ON UPDATE CASCADE,
                        ADD CONSTRAINT `product_seconds_brand_id_foreign` FOREIGN KEY (`brand_id`) REFERENCES `brands`
                        (`id`) ON DELETE SET NULL,
                        ADD CONSTRAINT `product_seconds_category_id_foreign` FOREIGN KEY (`category_id`) REFERENCES
                        ...
                        --
                        ALTER TABLE `purchase_details`
                        ADD CONSTRAINT `fk_pdet_prod` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE
                        SET NULL ON UPDATE CASCADE,
                        ADD CONSTRAINT `fk_pdet_pur` FOREIGN KEY (`purchase_id`) REFERENCES `purchases` (`id`) ON DELETE
                        CASCADE ON UPDATE CASCADE,
                        ADD CONSTRAINT `purchase_details_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES
                        `products` (`id`) ON DELETE SET NULL,
                        ADD CONSTRAINT `purchase_details_purchase_id_foreign` FOREIGN KEY (`purchase_id`) REFERENCES
                        ...
                        REFERENCES `permissions` (`id`) ON DELETE CASCADE,
                        ADD CONSTRAINT `role_has_permissions_role_id_foreign` FOREIGN KEY (`role_id`) REFERENCES `roles`
                        (`id`) ON DELETE CASCADE;
                        ...
                        ADD CONSTRAINT `fk_sdet_adjuster` FOREIGN KEY (`adjusted_by`) REFERENCES `users` (`id`) ON
                        DELETE SET NULL ON UPDATE CASCADE,
                        ADD CONSTRAINT `fk_sdet_product` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON
                        DELETE SET NULL ON UPDATE CASCADE,
                        ADD CONSTRAINT `fk_sdet_sale` FOREIGN KEY (`sale_id`) REFERENCES `sales` (`id`) ON DELETE
                        CASCADE ON UPDATE CASCADE,
                        ADD CONSTRAINT `sale_details_adjusted_by_foreign` FOREIGN KEY (`adjusted_by`) REFERENCES `users`
                        (`id`) ON DELETE SET NULL,
                        ADD CONSTRAINT `sale_details_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES
                        `products` (`id`) ON DELETE SET NULL,
                        ...
                        ADD CONSTRAINT `fk_spay_sale` FOREIGN KEY (`sale_id`) REFERENCES `sales` (`id`) ON DELETE
                        CASCADE ON UPDATE CASCADE;
                        ...
                        --
                        ALTER TABLE `service_masters`
                        ADD CONSTRAINT `fk_service_masters_created_by` FOREIGN KEY (`created_by`) REFERENCES `users`
                        (`id`) ON DELETE SET NULL,
                        ADD CONSTRAINT `service_masters_ibfk_1` FOREIGN KEY (`updated_by`) REFERENCES `users` (`id`) ON
                        DELETE SET NULL;
                        ...
                        --
                        ALTER TABLE `service_master_audits`
                        ADD CONSTRAINT `service_master_audits_ibfk_1` FOREIGN KEY (`service_master_id`) REFERENCES
                        `service_masters` (`id`) ON DELETE CASCADE,
                        ADD CONSTRAINT `service_master_audits_ibfk_2` FOREIGN KEY (`changed_by`) REFERENCES `users`
                        ...
                        --
                        ALTER TABLE `settings`
                        ADD CONSTRAINT `settings_default_currency_id_foreign` FOREIGN KEY (`default_currency_id`)
                        ...
                        --
                        ALTER TABLE `stock_movements`
                        ADD CONSTRAINT `stock_movements_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES
                        `products` (`id`) ON DELETE CASCADE,
                        ADD CONSTRAINT `stock_movements_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users`
                        (`id`) ON DELETE SET NULL;
                        ...
                        --
                        ALTER TABLE `user_activity_logs`
                        ADD CONSTRAINT `fk_user_activity_logs_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON
                        DELETE CASCADE;
                        COMMIT;
