...
<div id="toast-container" class="fixed top-20 right-5 z-50 space-y-4">
    ...
    @if(session('info'))
    <div id="toast-info" class="flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
