...
@can('access_sales')
    <li
        class="c-sidebar-nav-item c-sidebar-nav-dropdown {{ request()->routeIs(['sales.*', 'sale-payments.*']) ? 'c-show' : '' }}">
        <a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="#">
...
@can('access_reports')
    @php
        ...
        $link = fn(array $names) => collect($names)
...
@can('access_user_management')
    <li
        class="c-sidebar-nav-item c-sidebar-nav-dropdown {{ request()->routeIs(['roles.*', 'users.*']) ? 'c-show' : '' }}">
        <a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="#">
        ...
        <ul class="c-sidebar-nav-dropdown-items">
            ...
            <li class="c-sidebar-nav-item">
                <a class="c-sidebar-nav-link {{ request()->routeIs(['users.index', 'users.edit']) ? 'c-active' : '' }}"
...
@canany(['access_currencies', 'access_settings', 'access_units'])
    <li
        class="c-sidebar-nav-item c-sidebar-nav-dropdown {{ request()->routeIs(['currencies.*', 'units.*', 'settings.*']) ? 'c-show' : '' }}">
        <a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="#">
